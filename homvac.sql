...
(1, 4, 'Ana Trujillo', 'Female', '2021-06-08', 'Birth Certificate', '1630731599.jpg', 'Active'),
(2, 6, 'Christina Berglund', 'Female', '2021-05-05', 'Birth Certificate', '1630731599.jpg', 'Active');
...
(4, 7, 'Maria Anders', 'Mill House', 'Obere Str. 7', '9876543210', '1aA!1aA!', 'Active'),
(6, 1, 'Thomas Hardy', 'Woodlands', '120 Hanover Sq.', '7654321098', '3cC#3cC#', 'Active');
...
(5, 7, 4, 1, 1, 1, '2021-10-13', '11:30 AM - 12:30 PM', 'Pending', '0000-00-00', '00:00:00'),
(6, 1, 6, 2, 2, 2, '2021-10-20', '02:30 PM - 03:30 PM', 'Vaccinated', '2021-10-10', '20:13:12');
...
CREATE TABLE `tbl_vaccinator` (
  ...
  `vaccinator_password` varchar(30) NOT NULL,
  `vaccinator_status` varchar(10) NOT NULL,
...
CREATE TABLE `tbl_vaccine` (
  ...
  `vaccine_age` varchar(10) NOT NULL,
...
(1, '6 Weeks', 'OPV-1, Pentavalent-1, Rotavirus Vaccine (RVV)-1, Fractional Dose of Inactivated Polio Vaccine (fIPV)-1', 'Active'),
...
ALTER TABLE `tbl_vaccination`
  ADD CONSTRAINT `tbl_vaccination_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `tbl_user` (`user_id`),
  ADD CONSTRAINT `tbl_vaccination_ibfk_3` FOREIGN KEY (`member_id`) REFERENCES `tbl_member` (`member_id`),
  ADD CONSTRAINT `tbl_vaccination_ibfk_4` FOREIGN KEY (`vaccine_id`) REFERENCES `tbl_vaccine` (`vaccine_id`),
  ADD CONSTRAINT `tbl_vaccination_ibfk_5` FOREIGN KEY (`vaccinator_id`) REFERENCES `tbl_vaccinator` (`vaccinator_id`);
